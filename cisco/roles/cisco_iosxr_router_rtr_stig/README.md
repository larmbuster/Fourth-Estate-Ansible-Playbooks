# cisco_iosxr_router_rtr_stig

Cisco IOS-XR Router RTR DISA STIG V3 hardening role.

## STIG Reference

- **Title**: Cisco IOS XR Router RTR Security Technical Implementation Guide
- **Version**: 3
- **Release**: Release: 3 Benchmark Date: 01 Oct 2025
- **Benchmark ID**: Cisco_IOS-XR_Router_RTR_STIG
- **Total Rules**: 96 (CAT I: 10, CAT II: 57, CAT III: 29)
...
- `access_control` -- Access Control (46 rules)
...
- `cat2` -- All CAT II (medium) findings (57 rules)
- `cat3` -- All CAT III (low) findings (29 rules)
...
| CISC-RT-000070 | LOW | automated | system_hardening |
| CISC-RT-000130 | HIGH | automated | access_control |
...
| CISC-RT-000420 | MEDIUM | automated | access_control |
...
| CISC-RT-000550 | LOW | automated | routing |
...
| CISC-RT-000690 | LOW | automated | encryption |
