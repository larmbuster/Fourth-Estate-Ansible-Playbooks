...
Cisco IOS Switch L2S DISA STIG V3 hardening role.

## STIG Reference

- **Title**: Cisco IOS Switch L2S Security Technical Implementation Guide
- **Version**: 3
- **Release**: Release: 1 Benchmark Date: 24 Jul 2024
- **Benchmark ID**: Cisco_IOS_Switch_L2S_STIG
...
| CISC-L2-000040 | MEDIUM | automated | system_hardening |
