# cisco_iosxe_switch_ndm_stig

Cisco IOS-XE Switch NDM DISA STIG V3 hardening role.

## STIG Reference

- **Title**: Cisco IOS XE Switch NDM Security Technical Implementation Guide
- **Version**: 3
- **Release**: Release: 5 Benchmark Date: 05 Jan 2026
- **Benchmark ID**: Cisco_IOS_XE_Switch_NDM_STIG
