# cisco_iosxe_router_rtr_stig

Cisco IOS-XE Router RTR DISA STIG V3 hardening role.

## STIG Reference

- **Title**: Cisco IOS XE Router RTR Security Technical Implementation Guide
- **Version**: 3
- **Release**: Release: 5 Benchmark Date: 01 Oct 2025
- **Benchmark ID**: Cisco_IOS-XE_Router_RTR_STIG
- **Total Rules**: 97 (CAT I: 10, CAT II: 58, CAT III: 29)
...
| CISC-RT-000680 | HIGH | automated | routing |
...
| CISC-RT-000720 | MEDIUM | automated | routing |
