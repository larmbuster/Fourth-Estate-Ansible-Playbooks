...
Cisco IOS Router NDM DISA STIG V3 hardening role.

## STIG Reference

- **Title**: Cisco IOS Router NDM Security Technical Implementation Guide
- **Version**: 3
- **Release**: Release: 6 Benchmark Date: 05 Jan 2026
- **Benchmark ID**: Cisco_IOS_Router_NDM_STIG
