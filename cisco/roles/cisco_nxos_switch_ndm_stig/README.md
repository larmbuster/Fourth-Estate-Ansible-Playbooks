# cisco_nxos_switch_ndm_stig

Cisco NX-OS Switch NDM DISA STIG V3 hardening role.

## STIG Reference

- **Title**: Cisco NX OS Switch NDM Security Technical Implementation Guide
- **Version**: 3
- **Release**: Release: 6 Benchmark Date: 05 Jan 2026
- **Benchmark ID**: Cisco_NX-OS_Switch_NDM_STIG
- **Total Rules**: 42 (CAT I: 7, CAT II: 35, CAT III: 0)
...
| CISC-ND-000880 | MEDIUM | automated | authentication |
| CISC-ND-000940 | MEDIUM | automated | authentication |
...
| CISC-ND-001240 | MEDIUM | automated | authentication |
| CISC-ND-001250 | MEDIUM | automated | authentication |
| CISC-ND-001260 | MEDIUM | automated | logging |
| CISC-ND-001270 | MEDIUM | automated | authentication |
| CISC-ND-001280 | MEDIUM | automated | logging |
...
| CISC-ND-001440 | MEDIUM | automated | authentication |
